function registration() {
  ...
  /*
    ...
    */
  ...
  else if(!(password.match(/[1234567890]/) && password.match(/[qwertyuiopasdfghjklzxcvbnm]/) && password.match(/[QWERTYUIOPASDFGHJKLZXCVBNM]/) && password.match(/[!##$%^&*]/))){
    ...
    window.alert("password and c password does not mathced");
    document.querySelector(".cpassword").focus();
    return false;
 }
